...
void initialize() {
    cout << "start initialization..." << endl << flush;
    ...
    cout << "finish initialization..." << endl << flush;
}
...
int main(int argc, char *argv[]) {
    ...
    cout << "start from test " << start << endl << endl << flush;
    ...
    switch (start) {
        ...
        case 2: {
            ...
            bool result = false;
            {
                ...
                cout << "create PageIterator..." << endl << flush;
        ...
        case 3: {
            ...
            if (counter == 10000) cout << "CORRECT" << endl << endl << flush;
            else cout << "***FAIL***" << endl << endl << flush;
        ...
        case 4: {
            ...
            if (counter == 10001) cout << "CORRECT" << endl << endl << flush;
            else cout << "***FAIL***" << endl << endl << flush;
        ...
        case 5: {
            ...
            string result = "";
            {
                ...
                cout << "next 2nd record..." << endl << flush;
                if (myIter->hasNext()) {
                    myIter->getNext();
                }
                if (myIter->hasNext()) {
            ...
            if (result == answer) cout << "CORRECT" << endl << endl << flush;
            else cout << "***FAIL***" << endl << endl << flush;
        ...
        case 6: {
            ...
            string result = "";
            {
                ...
                cout << "page " << page << "...counter " << counter << "..." << endl << flush;
        ...
        case 7: {
            ...
            if (counter == 20000) cout << "CORRECT" << endl << endl << flush;
            else cout << "***FAIL***" << endl << endl << flush;
        ...
        case 8: {
            ...
            int counter = 0;
            {
                ...
                cout << "count records in page 33..." << endl << flush;
                while (myIter1->hasNext()) {
                    myIter1->getNext();
                    counter++;
                }

                cout << "clear page 33..." << endl << flush;
                supplierTable[33].clear();

                cout << "create TableIterator..." << endl << flush;
                MyDB_RecordIteratorPtr myIter2 = supplierTable.getIterator(temp);

                cout << "count records in table..." << endl << flush;
        ...
        case 9: {
            ...
            int counter = 0;
            {
                ...
                cout << "count records in page 55..." << endl << flush;
                while (myIter1->hasNext()) {
                    myIter1->getNext();
                    counter++;
                }

                cout << "clear page 55..." << endl << flush;
                supplierTable[55].clear();

                cout << "count records in the last page and copy to page 55..." << endl << flush;
                while (myIter2->hasNext()) {
                    myIter2->getNext();
        ...
        case 0: {
            ...
            if (result == false) cout << "CORRECT" << endl << endl << flush;
            else cout << "***FAIL***" << endl << endl << flush;
